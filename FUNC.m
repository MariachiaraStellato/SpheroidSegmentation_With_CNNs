classdef FUNC
    methods(Static)
        ...
        % General Public License for more details.
            Layers = [
                      convolution2dLayer(FilterSize,FilterNumber,"Name",ConvName,"BiasLearnRateFactor",0,"Padding",Padding,"Stride",stride,"WeightLearnRateFactor",w,"DilationFactor",dil)
        ...
        % General Public License for more details.
            Layers = [
                        depthConcatenationLayer(NumInput,"Name",DepthName)
        ...
        % General Public License for more details.
            Layers = [
                        FUNC.ConvBatchRelu(FilterSize,FilterNumber,0,[1 1],strcat("res",BatchName,"2a"),strcat("bn",BatchName,"2a"),strcat("res",BatchName,"2a_relu"),w,[1 1])
